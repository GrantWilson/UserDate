...
/*global window*/
/*global jQuery*/
// Based on the jquery plugin:  jquery.date_input.js    by Jon Leighton.
// Has been modified to use the UserDate class, which allows for time zone changes.

var UserDateInput = (function ($) { // Localise the $ function

    function UserDateInput(el, opts, tz) {
        this.timezone = tz;
        if (typeof (opts) !== "object") { opts = {}; }
        $.extend(this, UserDateInput.DEFAULT_OPTS, opts);
    ...
    UserDateInput.DEFAULT_OPTS = {
        month_names: ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"],
        short_month_names: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"],
        short_day_names: ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"],
        start_of_week: 1
    };
    UserDateInput.prototype = {
      ...
      '</p>');
        ...
        changeInput: function (dateString) {
            var a = this.input.val(dateString);
            a.change();
            this.hide();
        },
    ...
    //    return this.each(function () { new UserDateInput(this, opts); });
    //};
